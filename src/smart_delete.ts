...
export async function applySmartDeletion(editor: TextEditor, direction: Direction) {
...
export async function applySmartSelectionDeletion(editor: TextEditor) {
...
export async function applySmartCaretDeletion(
    editor: TextEditor,
    direction: Direction,
) {
    const { document, selection } = editor
