...
import { extractRustTargetReversed } from '@/lang/rust/extract_target'
import { inferType } from '@/lang/rust/infer_type'
...
//todo Realistically, you won't annotate a type on the next line. so by-line limitation is okay
